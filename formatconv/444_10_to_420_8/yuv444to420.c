...
int main(int argc, char **argv)
{
    ...
    uint32_t src_size = (horizontal*vertical) * 3 ;
    ...
    for (int i=0;;i++) {
        ...
        for (j=0;j<vertical;j++) {
            if (j%2) {
                ...
                for (k=0;k< horizontal;k++) {
                    if (k%2) {
                        *(dst_data + (horizontal*vertical) + ((j/2) * (horizontal/2)) + (k/2)) 
                             = *(src_data + (horizontal * vertical) + (j*(horizontal)) + k);
                    }
                }
        ...
        for (j=0;j<vertical;j++) {
            if (j%2) {
                ...
                for (k=0;k< horizontal;k++) {
                    if (k%2) {
                        *(dst_data + (horizontal*vertical) + ((horizontal/2)*(vertical/2)) + ((j/2) * (horizontal/2)) + (k/2)) 
                            =  *(src_data + (horizontal * vertical) + (horizontal * vertical) +(j*(horizontal)) + k);
                    }
                }
