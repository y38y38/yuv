...
int main(int argc, char **argv)
{
    ...
    for (int i=0;;i++) {
        ...
        //y
        memcpy(dst_data, src_data, 1920*1080*2);

        //cb
        memcpy(dst_data + ((1920*1080)*2), src_data + ((1920*1088)*2), ((1920*1080)*2) / 2);

        //cr
        memcpy(dst_data + ((1920*1080)*2) + (((1920*1080)*2) / 2), src_data + ((1920*1088)*2) + (((1920*1088)*2) / 2), (1920*1080)*2 /2);
