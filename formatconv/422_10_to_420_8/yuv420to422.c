...
int main(int argc, char **argv)
{
    ...
    uint32_t dst_size = (1920*1088) + (1920*1088) ;
    ...
    for (int i=0;;i++) {
        ...
        //y
        memcpy(dst_data, src_data, 1920*1088);

        //cb
        int j;
        for (j=0;j<544;j++) {
            memcpy(dst_data + (1920*1088) + (j*1920),       src_data + (1920*1088) + (j*960), 960);
            memcpy(dst_data + (1920*1088) + (j*1920) + 960, src_data + (1920*1088) + (j*960), 960);
        }
        //cb
        for (j=0;j<544;j++) {
            memcpy(dst_data + (1920*1088) + (960*1088) + (j*1920),       src_data + (1920*1088) + (960*544) + (j*960), 960);
            memcpy(dst_data + (1920*1088) + (960*1088) + (j*1920) + 960, src_data + (1920*1088) + (960*544) + (j*960), 960);
        }
